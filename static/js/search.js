document.addEventListener('DOMContentLoaded', function () {
    ...
    const initialExam = urlParams.get('exam') || '';
    ...
    if (initialExam) {
        selectedExams = [initialExam];
        examFilter.value = initialExam;
        
        // Load subjects and pre-select if provided
        loadSubjects(initialExam).then(() => {
            if (initialSubject) {
                selectedSubjects = [initialSubject];
                subjectFilter.disabled = false;
                subjectFilter.value = initialSubject;
                
                // Load chapters and pre-select if provided
                fetchFilters(initialExam, initialSubject, 'chapter').then(() => {
                    if (initialChapter) {
                        selectedChapters = [initialChapter];
                        chapterFilter.disabled = false;
                        chapterFilter.value = initialChapter;
                    }
                    // Fetch results after all filters are set
                    fetchResults();
                });
            } else {
                // Load papers for the exam
                fetchFilters(initialExam, '', 'paper');
                // Fetch results with just exam filter
                fetchResults();
            }
        });
    } else if (query) {
        // If no filters but has query, just search
            ...
            const examsData = [
                {
                    ...
                    "name": "JEE Main",
                    "subjects": [
                        ["7bc04a29-039c-430d-980d-a066b16efc86", "Physics"],
                        ["bdcc1b1b-5d9d-465d-a7b8-f9619bb61fe7", "Chemistry"],
                        ["f1d41a0c-1a71-4994-90f3-4b5d82a6f5f9", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "JEE Advanced",
                    "subjects": [
                        ["f66d8bfb-ba6a-4b3f-adbc-fbf402e39020", "Physics"],
                        ["17d9f684-251f-4f52-8092-1b54b33b1ed5", "Chemistry"],
                        ["96b44962-2c79-4a42-87ce-f8b87c9e174a", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "NDA",
                    "subjects": [
                        ["fb0ed4bb-f01a-41a7-8400-dc89ff53e59f", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "WBJEE",
                    "subjects": [
                        ["c41e01c9-86c8-41ff-8b48-e585020ec8c9", "Physics"],
                        ["2d96a490-384b-4984-9356-086b3baf166b", "Chemistry"],
                        ["168bd1c7-3c23-4d1c-ab40-fcf70bb1fb72", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "BITSAT",
                    "subjects": [
                        ["45363e06-86a7-4d8e-be8d-318ee79af980", "Physics"],
                        ["416dff44-e43b-4cd3-8c5a-d30b56d24151", "Chemistry"],
                        ["6848df90-e6d7-4505-a691-53956ebf45a2", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "VITEEE",
                    "subjects": [
                        ["fdd0de52-3277-408a-aed9-12c735635134", "Physics"],
                        ["2a6d5d09-a157-43a4-aa81-022f2e70f596", "Chemistry"],
                        ["c476840a-2596-4510-878c-d641b83469dc", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "MHT CET",
                    "subjects": [
                        ["eaccceff-1c6e-4d73-bab0-6b2a2a0fb0a0", "Physics"],
                        ["fe61bc1d-8b3b-4ce8-ab28-a156c8a62fb8", "Chemistry"],
                        ["2d820cff-7252-4a17-9f44-10b92970705e", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "COMEDK",
                    "subjects": [
                        ["1ff8290a-8193-4001-a93e-8aa8fcb1f3ac", "Physics"],
                        ["6ec16a3d-177a-44f3-b342-4c51cf2b1045", "Chemistry"],
                        ["3d7d5653-4382-4275-be29-58b0eea9f510", "Mathematics"]
                    ]
                },
                {
                    ...
                    "name": "NEET",
                    "subjects": [
                        ["4b89e781-8987-47aa-84b6-d95025d590b0", "Physics"],
                        ["45966dd6-eaed-452f-bfcc-e9632c72da0f", "Chemistry"],
                        ["634d1a76-ecfd-4d2b-bdb9-5d6658948236", "Biology"]
                    ]
                }
            ];
